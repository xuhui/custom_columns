...
ActionDispatch::Callbacks.to_prepare do
  ...
  ProjectsHelper.send(:include, EnhancedProjectSettingModule) unless ProjectsHelper.included_modules.include?(EnhancedProjectSettingModule)
  ProjectsController.send(:include, EnhanceProjectsControllerModule) unless ProjectsController.included_modules.include?(EnhanceProjectsControllerModule)
end
